...
import { ContainsMessageKeyTemplateDrivenValidationDecoratorsComponent } from './messageKey/contains-message-key.component';
...
@NgModule({
  declarations: [
	...
	ContainsMessageKeyTemplateDrivenValidationDecoratorsComponent,

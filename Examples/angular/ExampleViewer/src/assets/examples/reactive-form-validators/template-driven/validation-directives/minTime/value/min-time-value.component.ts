...
@Component({
    selector: 'app-minTime-value-template-driven-validation-directives',
    templateUrl: './min-time-value.component.html'
})
export class MinTimeValueTemplateDrivenValidationDirectivesComponent implements OnInit {

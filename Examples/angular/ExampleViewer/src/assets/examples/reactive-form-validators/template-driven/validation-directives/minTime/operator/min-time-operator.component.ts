...
@Component({
    selector: 'app-minTime-operator-template-driven-validation-directives',
    templateUrl: './min-time-operator.component.html'
})
export class MinTimeOperatorTemplateDrivenValidationDirectivesComponent implements OnInit {

...
export class ExtensionDynamicValidatorComponent implements OnInit {
    ...
    ngOnInit() {
		...
		this.http.get('https://rxwebioassets.blob.core.windows.net/$web/examples/reactive-form-validators/validators/extension/dynamic/dynamic.json?v='+environment.appVersion).subscribe(dynamic => {

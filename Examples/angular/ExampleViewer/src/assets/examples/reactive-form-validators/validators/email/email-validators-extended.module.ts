...
import { EmailMessageKeyValidatorComponent } from './messageKey/email-message-key.component';
...
@NgModule({
  declarations: [
	...
	EmailMessageKeyValidatorComponent,
...
export class  EmailValidatorsExtendedModule { }

...
@Component({
  selector: 'app-allOf-dynamic-validator',
  templateUrl: './all-of-dynamic.component.html'
})
export class AllOfDynamicValidatorComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get('https://rxwebioassets.blob.core.windows.net/$web/examples/reactive-form-validators/validators/allOf/dynamic/dynamic.json?v=' + environment.appVersion).subscribe(dynamic => {

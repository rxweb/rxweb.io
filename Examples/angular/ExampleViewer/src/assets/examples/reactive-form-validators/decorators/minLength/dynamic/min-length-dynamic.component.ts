...
export class MinLengthDynamicComponent implements OnInit {
    ...
    ngOnInit() {
		...
		this.http.get('https://rxwebioassets.blob.core.windows.net/$web/examples/reactive-form-validators/decorators/minLength/dynamic/dynamic.json?v=' + environment.appVersion).subscribe(dynamic => {

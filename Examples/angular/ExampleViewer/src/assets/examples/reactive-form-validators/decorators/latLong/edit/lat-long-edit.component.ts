...
export class LatLongEditComponent implements OnInit {
    ...
    ngOnInit() {
        this.http.get('https://rxwebioassets.blob.core.windows.net/$web/examples/reactive-form-validators/decorators/latLong/edit/country-data.json?v=' + environment.appVersion).subscribe(country => {

...
import { OneOfMessageKeyValidatorComponent } from "src/assets/examples/reactive-form-validators/validators/oneOf/messageKey/one-of-message-key.component";
import { OneOfMessageKeyComponent } from "src/assets/examples/reactive-form-validators/decorators/oneOf/messageKey/one-of-message-key.component";
...
export const ONE_OF_COMPONENT_EXAMPLE_CONSTANT: { [key: string]: any } = {
  decorators: {
    ...
    messageKey: OneOfMessageKeyComponent
  },
  ...
  validators: {
    ...
    messageKey: OneOfMessageKeyValidatorComponent
  },
}

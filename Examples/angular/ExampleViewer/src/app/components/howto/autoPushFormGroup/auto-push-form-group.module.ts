...
import { AutoPushFormGroupValidatorsExtendedModule } from "src/assets/examples/howto/validators/autoPushFormGroup/auto-push-form-group-validators-extended.module";
...
@NgModule({
  imports: [AUTO_PUSH_FORM_GROUP_ROUTING ,AutoPushFormGroupDecoratorsExtendedModule ,AutoPushFormGroupValidatorsExtendedModule,PageModule],

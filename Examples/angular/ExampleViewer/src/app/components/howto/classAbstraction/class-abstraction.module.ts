...
import { ClassAbstractionDecoratorsExtendedModule } from "src/assets/examples/howto/decorators/classAbstraction/class-abstraction-decorators-extended.module";
...
@NgModule({
  imports: [CLASS_ABSTRACTION_ROUTING ,ClassAbstractionDecoratorsExtendedModule ,PageModule],

      ...
      //  //let keyName = element.getAttribute("key");
        ...
        if(refComponentString){
            ...
            let refComponent = refComponentString.split('-');
                ...
                else if(dynamicsplitedArray[1] == "reactive-dynamic-forms" || dynamicsplitedArray[1] == "rxweb-generics" || dynamicsplitedArray[1] == "rxweb-http" || dynamicsplitedArray[1] == "rxweb-sanitizers")

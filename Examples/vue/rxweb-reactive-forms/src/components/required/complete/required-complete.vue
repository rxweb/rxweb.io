     ...
     <form>
       <div class="form-group">
        ...
        <div v-if="userFormGroup.controls.firstName.errors">
         <small class="form-text text-danger">{{userFormGroup.controls.firstName.errors.required.message}}<br/></small>	
       </div>
      </div>  
    <div class="form-group">
       ...
       <div v-if="userFormGroup.controls.middleName.errors">
         <small class="form-text text-danger">{{userFormGroup.controls.middleName.errors.required.message}}<br/></small>	
       </div>
      </div>  
    <div class="form-group">
       ...
       <div v-if="userFormGroup.controls.lastName.errors">
         <small class="form-text text-danger">{{userFormGroup.controls.lastName.errors.required.message}}<br/></small>	
       </div>
      </div>  
    <div class="form-group">
       ...
       <div v-if="userFormGroup.controls.userName.errors">
         <small class="form-text text-danger">{{userFormGroup.controls.userName.errors.required.message}}<br/></small>	
       </div>
      </div>  
    <div class="form-group">
       ...
       <div v-if="userFormGroup.controls.fullName.errors">
         <small class="form-text text-danger">{{userFormGroup.controls.fullName.errors.required.message}}<br/></small>	
       </div>
      </div>  
...
@Component
export default class RequiredCompleteComponent extends Vue {

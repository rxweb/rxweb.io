...
import  AlphaLocaleComponent  from '../components/alpha/locale/alpha-locale.vue';
...
import  AlphaNumericLocaleComponent  from '../components/alphaNumeric/locale/alpha-numeric-locale.vue';
...
import  MaskCompleteComponent  from '../components/mask/complete/mask-complete.vue';
import  MaskMaskComponent  from '../components/mask/mask/mask-mask.vue';
import  MaskConditionalExpressionComponent  from '../components/mask/conditionalExpression/mask-conditional-expression.vue';
import  MaskMessageComponent  from '../components/mask/message/mask-message.vue';
import  MaskMessageKeyComponent  from '../components/mask/messageKey/mask-message-key.vue';
import  MaskDynamicComponent  from '../components/mask/dynamic/mask-dynamic.vue';
import  MaskAddComponent  from '../components/mask/add/mask-add.vue';
import  MaskEditComponent  from '../components/mask/edit/mask-edit.vue';
...
import  RequiredTrueCompleteComponent  from '../components/requiredTrue/complete/required-true-complete.vue';
import  RequiredTrueConditionalExpressionComponent  from '../components/requiredTrue/conditionalExpression/required-true-conditional-expression.vue';
import  RequiredTrueMessageComponent  from '../components/requiredTrue/message/required-true-message.vue';
import  RequiredTrueMessageKeyComponent  from '../components/requiredTrue/messageKey/required-true-message-key.vue';
import  RequiredTrueDynamicComponent  from '../components/requiredTrue/dynamic/required-true-dynamic.vue';
import  RequiredTrueAddComponent  from '../components/requiredTrue/add/required-true-add.vue';
import  RequiredTrueEditComponent  from '../components/requiredTrue/edit/required-true-edit.vue';
...
import  UrlUrlValidationTypeComponent  from '../components/url/urlValidationType/url-url-validation-type.vue';
...
import  IpCompleteComponent  from '../components/ip/complete/ip-complete.vue';
import  IpVersionComponent  from '../components/ip/version/ip-version.vue';
import  IpIsCidrComponent  from '../components/ip/isCidr/ip-is-cidr.vue';
import  IpConditionalExpressionComponent  from '../components/ip/conditionalExpression/ip-conditional-expression.vue';
import  IpMessageComponent  from '../components/ip/message/ip-message.vue';
import  IpMessageKeyComponent  from '../components/ip/messageKey/ip-message-key.vue';
import  IpDynamicComponent  from '../components/ip/dynamic/ip-dynamic.vue';
import  IpAddComponent  from '../components/ip/add/ip-add.vue';
import  IpEditComponent  from '../components/ip/edit/ip-edit.vue';
import  ComposeCompleteComponent  from '../components/compose/complete/compose-complete.vue';
import  ComposeValidatorsComponent  from '../components/compose/validators/compose-validators.vue';
import  ComposeMessageKeyComponent  from '../components/compose/messageKey/compose-message-key.vue';
import  ComposeConditionalExpressionComponent  from '../components/compose/conditionalExpression/compose-conditional-expression.vue';
import  ComposeMessageComponent  from '../components/compose/message/compose-message.vue';
import  ComposeDynamicComponent  from '../components/compose/dynamic/compose-dynamic.vue';
import  ComposeAddComponent  from '../components/compose/add/compose-add.vue';
import  ComposeEditComponent  from '../components/compose/edit/compose-edit.vue';
...

{
   path: '/alpha-locale',
    name: 'alpha-locale',
    component: AlphaLocaleComponent
},
...
{
   path: '/alpha-numeric-locale',
    name: 'alpha-numeric-locale',
    component: AlphaNumericLocaleComponent
},
...

{
   path: '/mask-complete',
    name: 'mask-complete',
    component: MaskCompleteComponent
},
...

{
   path: '/mask-mask',
    name: 'mask-mask',
    component: MaskMaskComponent
},


{
   path: '/mask-conditional-expression',
    name: 'mask-conditional-expression',
    component: MaskConditionalExpressionComponent
},
...

{
   path: '/mask-message',
    name: 'mask-message',
    component: MaskMessageComponent
},


{
   path: '/mask-message-key',
    name: 'mask-message-key',
    component: MaskMessageKeyComponent
},
...

{
   path: '/mask-dynamic',
    name: 'mask-dynamic',
    component: MaskDynamicComponent
},
...
{
   path: '/required-true-complete',
    name: 'required-true-complete',
    component: RequiredTrueCompleteComponent
},


{
   path: '/required-true-conditional-expression',
    name: 'required-true-conditional-expression',
    component: RequiredTrueConditionalExpressionComponent
},
...

{
   path: '/required-true-message',
    ...
    component: RequiredTrueMessageComponent
},


{
   path: '/required-true-message-key',
    name: 'required-true-message-key',
    component: RequiredTrueMessageKeyComponent
},


{
   path: '/required-true-dynamic',
    name: 'required-true-dynamic',
    component: RequiredTrueDynamicComponent
},


{
   path: '/required-true-add',
    name: 'required-true-add',
    component: RequiredTrueAddComponent
},


{
   path: '/required-true-edit',
    name: 'required-true-edit',
    component: RequiredTrueEditComponent
},
...
{
   path: '/url-url-validation-type',
    name: 'url-url-validation-type',
    component: UrlUrlValidationTypeComponent
},
...

{
   path: '/ip-is-cidr',
    name: 'ip-is-cidr',
    component: IpIsCidrComponent
},


{
   path: '/ip-conditional-expression',
    name: 'ip-conditional-expression',
    component: IpConditionalExpressionComponent
},
...

{
   path: '/ip-message-key',
    name: 'ip-message-key',
    component: IpMessageKeyComponent
},
...

{
   path: '/ip-edit',
    name: 'ip-edit',
    component: IpEditComponent
},


{
   path: '/compose-complete',
    name: 'compose-complete',
    component: ComposeCompleteComponent
},


{
   path: '/compose-validators',
    name: 'compose-validators',
    component: ComposeValidatorsComponent
},


{
   path: '/compose-message-key',
    name: 'compose-message-key',
    component: ComposeMessageKeyComponent
},


{
   path: '/compose-conditional-expression',
    name: 'compose-conditional-expression',
    component: ComposeConditionalExpressionComponent
},
...
{
   path: '/compose-dynamic',
    name: 'compose-dynamic',
    component: ComposeDynamicComponent
},
...

{
   path: '/compose-edit',
    name: 'compose-edit',
    component: ComposeEditComponent
},

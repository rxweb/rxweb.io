...
export class HomeComponent implements OnInit {
  typeItTexts = [
    ...
    {
      type: 'code', fixText: '',data:{type:'radio',name:'gender',ui:{ label:"Gender"},source:[{text:"Male",value:1},{text:"Female",value:2}]}, imagePath: "assets/images/dynamic-forms/radio.png",codes: [{ text: '{', class: "typeit-json-text", speed: "fast" }, { text: " ", class: "type-it-tabing" }, { text: '"name":', class: "typeit-start-text", speed: "slow" }, { text: '"gender"', class: 'typeit-parameter-type', speed: "slow" }, { text: ',', class: "typeit-json-text", speed: "fast" }, { text: " ", class: "type-it-tabing" }, { text: '"type":', class: "typeit-start-text", speed: "slow" }, { text: '"radio"', class: "typeit-parameter-type", speed: "slow" }, { text: ',', class: "typeit-json-text", speed: "fast" }, { text: " ", class: "type-it-tabing" }, { text: '"source":', class: "typeit-start-text", speed: "fast" }, { text: "[{", speed: "fast" }, { text: '"value":', class: "typeit-start-text", speed: "fast" }, { text: '1', class: "typeit-parameter-type", speed: "fast" }, { text: ",", speed: "fast" }, { text: '"text":', class: "typeit-start-text", speed: "fast" }, { text: '"Male"', class: "typeit-parameter-type", speed: "fast" },{text:',',speed:"fast"},{ text: '2', class: "typeit-parameter-type", speed: "fast" }, { text: ",", speed: "fast" }, { text: '"text":', class: "typeit-start-text", speed: "fast" }, { text: '"Female"', class: "typeit-parameter-type", speed: "fast" }, { text: "}]", speed: "fast" },{text:",",speed:"fast"}, { text: " ", class: "typeit-json-text", speed: "fast" },{ text: " ", class: "type-it-tabing" },{text:'"ui":',class:"typeit-start-text",speed:"fast"},{ text: "{", speed: "fast" },{text:'"label":',class:"typeit-start-text",speed:"fast"},{text:'"Gender"',class:"typeit-parameter-type",speed:"fast"},{ text: '}', speed: "fast" },{ text: " ", class: "typeit-json-text", speed: "fast" },{ text: "}", speed: "fast" }, { text: ',', class: "typeit-json-text", speed: "fast" }]
    },
    {

...
export class EvenDynamicValidatorComponent implements OnInit {
    ...
    ngOnInit() {
		...
		this.http.get('https://rxwebioassets.blob.core.windows.net/$web/examples/reactive-form-validators/validators/even/dynamic/dynamic.json?v='+environment.appVersion).subscribe(dynamic => {

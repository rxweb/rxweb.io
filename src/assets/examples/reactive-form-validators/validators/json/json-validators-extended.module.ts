...
import { JsonMessageKeyValidatorComponent } from './messageKey/json-message-key.component';
...
@NgModule({
  declarations: [
	...
	JsonMessageKeyValidatorComponent,
...
export class  JsonValidatorsExtendedModule { }

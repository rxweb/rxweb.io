...
import { CompareMessageKeyValidatorComponent } from './messageKey/compare-message-key.component';
...
@NgModule({
  declarations: [
	...
	CompareMessageKeyValidatorComponent,
...
export class  CompareValidatorsExtendedModule { }

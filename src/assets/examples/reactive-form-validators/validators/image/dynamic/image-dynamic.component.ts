...
export class ImageDynamicValidatorComponent implements OnInit {
    ...
    ngOnInit() {
		...
		this.http.get('https://rxwebioassets.blob.core.windows.net/$web/examples/reactive-form-validators/validators/image/dynamic/dynamic.json?v='+environment.appVersion).subscribe(dynamic => {

...
export class RequiredEditComponent implements OnInit {
    ...
    ngOnInit() {
        this.http.get('https://rxwebioassets.blob.core.windows.net/$web/examples/reactive-form-validators/decorators/required/edit/user-info-data.json?v=' + environment.appVersion).subscribe(userInfo => {

...
export class ExtensionEditComponent implements OnInit {
    ...
    ngOnInit() {
        this.http.get('https://rxwebioassets.blob.core.windows.net/$web/examples/reactive-form-validators/decorators/extension/edit/user-info-data.json?v=' + environment.appVersion).subscribe(userInfo => {

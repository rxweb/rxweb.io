...
export class LongitudeEditComponent implements OnInit {
    ...
    ngOnInit() {
        this.http.get('https://rxwebioassets.blob.core.windows.net/$web/examples/reactive-form-validators/decorators/longitude/edit/number-info-data.json?v=' + environment.appVersion).subscribe(numberInfo => {

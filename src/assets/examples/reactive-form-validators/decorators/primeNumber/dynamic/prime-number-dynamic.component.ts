...
export class PrimeNumberDynamicComponent implements OnInit {
    ...
    ngOnInit() {
		...
		this.http.get('https://rxwebioassets.blob.core.windows.net/$web/examples/reactive-form-validators/decorators/primeNumber/dynamic/dynamic.json?v=' + environment.appVersion).subscribe(dynamic => {

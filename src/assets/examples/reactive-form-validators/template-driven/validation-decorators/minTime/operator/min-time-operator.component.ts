...
@Component({
    selector: 'app-minTime-operator-template-driven-validation-decorators',
    templateUrl: './min-time-operator.component.html'
})
export class MinTimeOperatorTemplateDrivenValidationDecoratorsComponent implements OnInit {

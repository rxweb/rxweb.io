...
@Component({
    selector: 'app-maxTime-operator-template-driven-validation-decorators',
    templateUrl: './max-time-operator.component.html'
})
export class MaxTimeOperatorTemplateDrivenValidationDecoratorsComponent implements OnInit {

...
import { FileMessageKeyTemplateDrivenValidationDecoratorsComponent } from './messageKey/file-message-key.component';
...
@NgModule({
  declarations: [
	...
	FileMessageKeyTemplateDrivenValidationDecoratorsComponent,

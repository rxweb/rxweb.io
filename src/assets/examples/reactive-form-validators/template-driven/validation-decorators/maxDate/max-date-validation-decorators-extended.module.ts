...
import { MaxDateMessageKeyTemplateDrivenValidationDecoratorsComponent } from './messageKey/max-date-message-key.component';
...
@NgModule({
  declarations: [
	...
	MaxDateMessageKeyTemplateDrivenValidationDecoratorsComponent,

...
@Component({
    selector: 'app-time-messageKey-template-driven-validation-directives',
    templateUrl: './time-message-key.component.html'
})
export class TimeMessageKeyTemplateDrivenValidationDirectivesComponent implements OnInit {

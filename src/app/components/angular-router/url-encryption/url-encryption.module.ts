...
import { ROUTER_URL_ENCRYPTION_ROUTING } from './url-encryption.routing';



@NgModule({
  imports: [ROUTER_URL_ENCRYPTION_ROUTING ,PageModule],
  exports: [RouterModule],
    providers:[{ provide: COMPONENT_EXAMPLE, useValue: ROUTER_AUTHENTICATION_COMPONENT_EXAMPLE_CONSTANT }]
  })
export class Router_UrlEncryptionModule { }
...
export class PageComponent implements OnInit {
 ...
 this.applicationBroadcaster.topSubject.subscribe(t=>{
  ...
  bind() {
    ...
    let codeUri = "";
    let htmlUri = ""
    if (this.mainType != "reactive-dynamic-forms" && this.mainType != "rxweb-storage" &&  this.mainType != "vue"  && this.mainType != "rxweb-http" && this.mainType != "rxweb-generics" && this.mainType != "rxweb-sanitizers") {

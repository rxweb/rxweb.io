...
import { LabelExtendedModule } from 'src/assets/examples/dynamic-forms/ui-features/label/label-extended.module';
import { LABEL_COMPONENT_EXAMPLE_CONSTANT } from './label.constant';

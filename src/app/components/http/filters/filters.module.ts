...
import { FiltersValidatorsExtendedModule } from "src/assets/examples/http/filters/filters-validators-extended.module";
...
@NgModule({
  imports: [FILTERS_ROUTING ,FiltersValidatorsExtendedModule,PageModule],

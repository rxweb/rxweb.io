...
<div class="title-bar top_title"><p>{{Title}}</p></div> <div class="title-bar"><p>ascii validation {{validatorType}} allows user to enter the input which is in the proper ascii format.</p></div>

...
<div class="title-bar top_title"><p>{{Title}}</p></div> <div class="title-bar"><p>greater than validation {{validatorType}} will check that user's input is greater than related field input.</p></div>

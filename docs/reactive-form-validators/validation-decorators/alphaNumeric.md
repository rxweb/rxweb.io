...
<div class="title-bar top_title"><p>{{Title}}</p></div> <div class="title-bar"><p>alphaNumeric validation {{validatorType}} will allow only alphabets and numbers to be entered. It will not allow any special character.</p></div>
...
<div component="app-example-runner" ref-component="app-alphaNumeric-messageKey" title="alphaNumeric {{validatorType}} with messageKey" key="messageKey"></div>

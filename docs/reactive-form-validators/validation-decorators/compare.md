...
<div class="title-bar top_title"><p>{{Title}}</p></div> <div class="title-bar"><p>compare validation  {{validatorType}}  will compare two inputs whether they are same or not.</p></div>

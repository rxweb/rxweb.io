...
<div class="title-bar top_title"><p>{{Title}}</p></div> <div class="title-bar"><p>required validation  {{validatorType}}  will check that the user has entered the value in the property or not.</p></div>
...
<div component="app-code" key="required-messageKeyExample-model"></div> 
<div component="app-example-runner" ref-component="app-required-messageKey" title="required {{validatorType}} with messageKey" key="messageKey"></div>

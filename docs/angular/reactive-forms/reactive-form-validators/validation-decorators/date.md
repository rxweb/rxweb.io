...
<tr><td><a  (click)='scrollTo("#isodate")'  title="isodate">allowISO</a></td><td>To allow standard way to express a numeric calendar date according to International Organization for Standardization</td></tr>
...
To allow standard way to express a numeric calendar date according to International Organization for Standardization. For example : 1981-04-05 i.e in a format of YYYY-MM-DD

<div component="app-code" key="date-allowISODateExample-model"></div> 
<div component="app-example-runner" ref-component="app-date-allowISODate" title="date {{validatorType}} with allowISODate" key="allowISODate"></div>
